...
## v4.9 최종 검증 (2026-03-23) — 모든 Epic/Story 정리 후

- 실행일: 2026-03-23 (모든 15개 Epic 스토리 확정 후)
- 시뮬레이터: `tools/balance-v48-sim.js`
- 결과:
  ```
  P1 solo: 53.5%      (구조적 한계, solo 허용)
  P2:  51.7% OK ✓
  P5:  52.3% OK ✓
  P10: 52.4% OK ✓
  P15: 52.4% OK ✓
  P20: 51.6% OK ✓
  P30: 51.3%  (구조적 한계 허용 ~51%)
  P50: 51.4%  (구조적 한계)
  P80: 51.3%  (구조적 한계)
  P100: 50.8% (구조적 한계)
  ```
- Per-pickaxe (basic @ 5p): P10=27.3% P50=43.4% P95=123.1%
- 잭팟 풀: 20p 기준 ~1시간 내 50K threshold 도달
- 판정: P2~P20 범위 모두 51.5% 이상 통과 ✓
...
- HE 하한선 51.5% 엄수
- P30+ 구조적 한계: ~51% (시스템 곡괭이 최대 4개로 이 이상 HE 확보 불가)
